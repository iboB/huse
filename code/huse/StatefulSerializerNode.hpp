...
class StatefulSerializerObject;
template <typename Serializer>
class StatefulSerializerArray;

template <typename Serializer>
class StatefulSerializerNode : public impl::UniqueStack {
protected:
    template <typename S>
    friend class StatefulSerializerNode;

    Serializer* m_serializer;
    bool m_ownsClose = false;
public:
    StatefulSerializerNode(Serializer& s) noexcept
        : UniqueStack(nullptr)
        , m_serializer(&s)
    {}

    template <std::derived_from<Serializer> OtherSerializer>
    StatefulSerializerNode(StatefulSerializerNode<OtherSerializer>& other, bool ownsClose = false) noexcept
        : UniqueStack(&other)
    ...
    template <std::derived_from<Serializer> OtherSerializer>
    StatefulSerializerNode(StatefulSerializerNode<OtherSerializer>&& other) noexcept
    ...
    StatefulSerializerArray<Serializer> ar();
    StatefulSerializerObject<Serializer> obj();
};

template <typename Serializer>
class StatefulSerializerArray : public StatefulSerializerNode<Serializer> {
public:
    using Node = StatefulSerializerNode<Serializer>;

    template <std::derived_from<Serializer> OtherSerializer>
    StatefulSerializerArray(StatefulSerializerArray<OtherSerializer>& other, bool ownsClose = false) noexcept
        : Node(other, ownsClose)
    {}
    template <std::derived_from<Serializer> OtherSerializer>
    StatefulSerializerArray(StatefulSerializerArray<OtherSerializer>&& other) noexcept
        : Node(std::move(other))
    {}

    ~StatefulSerializerArray() {
        if (this->m_ownsClose) {
...
template <typename Serializer>
class StatefulSerializerObject : private StatefulSerializerNode<Serializer> {
public:
    using Node = StatefulSerializerNode<Serializer>;

    template <std::derived_from<Serializer> OtherSerializer>
    StatefulSerializerObject(StatefulSerializerObject<OtherSerializer>& other, bool ownsClose = false) noexcept
        : Node(other, ownsClose)
    {}
    template <std::derived_from<Serializer> OtherSerializer>
    StatefulSerializerObject(StatefulSerializerObject<OtherSerializer>&& other) noexcept
        : Node(std::move(other))
    {}

    ~StatefulSerializerObject() {
        if (this->m_ownsClose) {
            HUSE_ASSERT_INTERNAL(this->m_serializer);
    ...
    StatefulSerializerObject obj(std::string_view k) {
        return key(k).obj();
    }
    StatefulSerializerArray<Serializer> ar(std::string_view k) {
        return key(k).ar();
    }
...
template <typename Serializer>
StatefulSerializerArray<Serializer> StatefulSerializerNode<Serializer>::ar() {
    return open(Array{});
}
template <typename Serializer>
StatefulSerializerObject<Serializer> StatefulSerializerNode<Serializer>::obj() {
    return open(Object{});
}
...
concept HasSerializeMethod = requires(T t, StatefulSerializerNode<Serializer>& node) {
    t.huseSerialize(node);
};
template <typename T, typename Serializer>
concept HasSerializeFunc = requires(StatefulSerializerNode<Serializer>& node, T t) {
...
template <typename T, typename Serializer>
concept HasOpenMethod = requires(T t, StatefulSerializerNode<Serializer>&node) {
    t.huseOpen(node);
};
template <typename T, typename Serializer>
concept HasOpenFunc = requires(StatefulSerializerNode<Serializer>&node, T t) {
    huseOpen(node, t);
};


template <typename T, typename Serializer>
concept HasSerializeFlatMethod = requires(T t, StatefulSerializerObject<Serializer>& obj) {
    t.huseSerializeFlat(obj);
};
template <typename T, typename Serializer>
concept HasSerializeFlatFunc = requires(StatefulSerializerObject<Serializer>& obj, T t) {
...
template <typename Serializer>
template <typename V>
void StatefulSerializerNode<Serializer>::val(V&& v) {
...
template <typename Serializer>
template <typename O>
decltype(auto) StatefulSerializerNode<Serializer>::open(O&& o) {
    if constexpr (impl::HasOpen<Serializer, O>) {
        m_serializer->open(std::forward<O>(o));
        return StatefulSerializerNode<Serializer>(*this, true);
    }
...
template <typename Serializer>
template <typename FV>
void StatefulSerializerObject<Serializer>::flatval(FV&& v) {
