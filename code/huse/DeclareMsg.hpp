...
#define HUSE_S_MSG(export, type, tag) DYNAMIX_DECLARE_EXPORTED_MSG_EX(export, HUSE_S_MSG_NAME(tag), ::huse::DYNAMIX_FUNC_TRAITS_NAME(husePolySerialize), \
    husePolySerialize, void, (::huse::Serializer&, type));
